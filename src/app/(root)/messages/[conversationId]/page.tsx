...
const ConversationsIdPage = ({ params }: ConversationsIdPageProps) => {
   ...
   const { mutateAsync: createMessageAsync, isPending: createMessagePending } = useCreateMessage()
   const { data: orderData, isLoading: orderLoading } = useGetOrderByConversations({
     conversationId: params.conversationId as Id<"conversations">,
   })
         ...
         <div className="max-w-4xl mx-auto w-full space-y-6">
           <AnimatePresence initial={false}>
             {messages?.map((message, i) => {
               ...
               const isFirstMessage = i === 0 || messages[i - 1]?.senderId !== message.senderId
               ...
               return (
                 ...
                 >
                   ...
                   <div className={cn("max-w-[85%] md:max-w-[70%]", !isCurrentUser && !isFirstMessage && "ml-10")}>
